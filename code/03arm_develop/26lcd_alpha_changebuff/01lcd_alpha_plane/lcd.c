...
static void lcd_init()
{
	 ...
	 * [1]: 如果是平面混合，本位将用于选择2个alpha值（在VIDOSD1C中设置）中的一个
	 *
	 */
	...
	VIDOSD1C = win[1].alpha_val << 12 | win[1].alpha_val << 16 | win[1].alpha_val << 20; //只设了alpha0的值
	...
	clear_screen(win + 1, RGB888(0, 0, 255));
	draw_rect(win + 1, XSIZE / 4, YSIZE / 4, XSIZE / 2, YSIZE / 2, RGB888(255, 0, 0));
}
