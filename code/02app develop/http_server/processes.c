...
static char* get_program_name (pid_t pid)
{
	...
	char* close_paren;
	char* result;
	/* Generate the name of the "stat" file in the process's /proc directory, and open it. */
	...
	status_info[rval] = '\0';
	/* The program name is the second element of the file contents and is surrounded by parentheses. Find the positions of the parentheses in the file contents. */
...
void module_generate (int fd)
{
	...
	/* Deallocate the buffers we created.
